...
def plot_figure(grouped, columnname, ylabel, title, xlim, ylim, figure_name, styles, logy):
    fig,ax = plt.subplots()
...
if __name__=="__main__":
    ...
    plot_figure(grouped, 'R', r'$\displaystyle \rho [kg/m^3]$',"Density with different models", [500,600], [0,1000], "density.png", styles,True)
